...
namespace App\Inventories\Products\Requests;

use App\Inventories\Products\Concerns\ValidatesAccessibleWarehouseInput;
...
class ProductUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'wooStatus' => 'sometimes|nullable|in:draft,publish',
