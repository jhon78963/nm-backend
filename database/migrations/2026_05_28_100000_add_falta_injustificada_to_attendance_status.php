...
{
    /**
     * Falta injustificada: ausencia sin aviso. Equivale a 2 faltas en nómina.
     */
    public function up(): void
    {
        ...
        if ($driver === 'pgsql') {
            ...
            DB::statement("ALTER TABLE attendances ADD CONSTRAINT attendances_status_check CHECK (status IN (
                'PUNTUAL','TARDE','FALTA','DESCANSO','VACACIONES','RECUPERACION','VALDEO','TOLERANCIA','FALTA_INJUSTIFICADA'
            ))");
